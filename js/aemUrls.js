        ...
        for (i = 0; i < arrFragURL.length; i++) {
            ...
            if ($arr != "" && $arr.indexOf('.html') !== -1) {
                ...
                if (type === "type is not defined") {
                    $("#error").html("<p class='mb-0'>Please make sure the Url(s) you are inputing are valid aem Url(<a href='#' data-toggle='tooltip' data-placement='bottom' title='https://www.canada.ca/'>Live</a>, <a href='#' data-toggle='tooltip' data-placement='bottom' title='https://author-canada-prod.adobecqms.net/sites.html/'>AEM path</a>, <a href='#' data-toggle='tooltip' data-placement='bottom' title='https://author-canada-prod.adobecqms.net/editor.html/'>Editor</a>, <a href='#' data-toggle='tooltip' data-placement='bottom' title='https://canada-preview.adobecqms.net/'>Preview</a>)  </p>");
                    $("#error").show();
                    console.log($arr);
                } else {
                    switch (type) {
